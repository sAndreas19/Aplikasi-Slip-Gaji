    ...
    <div class="container-fluid">
        ...
        <div class="card" style="width: 60%; margin-bottom: 100px;">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.data_jabatan.update', $jabatan-> id_jabatan) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="uang_transport" class="form-control" value="{{ old('uang_transport', $jabatan->uang_transport) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="uang_makan" class="form-control" value="{{ old('uang_makan', $jabatan->uang_makan) }}" required>
                        @error('uang_makan')
                            <div class="text-small text-danger">{{ $message }}</div>
                        @enderror
                    </div>
